...
export const metadata: Metadata = {
  title: "Privacy Policy | InventaGrow",
  description: "Privacy Policy for using the InventaGrow service.",
};
...
<li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to InventaGrow, RAJASTHAN.</p></li>
...
<li><p><strong>Country</strong> refers to: Rajasthan, India</p></li>
...
<li><p><strong>Website</strong> refers to InventaGrow, accessible from <a href="https://inventagrow.com/" rel="external nofollow noopener" target="_blank">https://inventagrow.com/</a>.</p></li>
...
<ul>
<li><p>Account Information</p><ul><li>User Accounts: retained for the duration of your account relationship plus up to 24 months after account closure to handle any post-termination issues or resolve disputes.</li></ul></li>
<li><p>Customer Support Data</p><ul><li>Support tickets and correspondence: up to 24 months from the date of ticket closure to resolve follow-up inquiries, track service quality, and defend against potential legal claims</li><li>Chat transcripts: up to 24 months for quality assurance and staff training purposes.</li></ul></li>
<li><p>Usage Data</p><ul><li>Website analytics data (cookies, IP addresses, device identifiers): up to 24 months from the date of collection, which allows us to analyze trends while respecting privacy principles.</li><li>Server logs (IP addresses, access times): up to 24 months for security monitoring and troubleshooting purposes.</li></ul></li>
</ul>
...
<ul><li>Legal obligation: We are required by law to retain specific data (e.g., financial records for tax authorities).</li><li>Legal claims: Data is necessary to establish, exercise, or defend legal claims.</li><li>Your explicit request: You ask Us to retain specific information.</li><li>Technical limitations: Data exists in backup systems that are scheduled for routine deletion.</li></ul>
...
<ul><li>Deletion: Personal Data is removed from Our systems and no longer actively processed.</li><li>Backup retention: Residual copies may remain in encrypted backups for a limited period consistent with our backup retention schedule and are not restored except where necessary for security, disaster recovery, or legal compliance.</li><li>Anonymization: In some cases, We convert Personal Data into anonymous statistical data that cannot be linked back to You. This anonymized data may be retained indefinitely for research and analytics.</li></ul>
...
<ul><li>By email: help@inventagrow.com</li></ul>
`;
  ...
  return (
    <main className="min-h-screen bg-[#f6f7f3] px-6 py-16 text-[#17181f] lg:px-10">
      <div className="mx-auto max-w-4xl rounded-[2rem] border border-black/10 bg-white p-8 shadow-[0_20px_60px_rgba(17,24,39,0.08)] sm:p-12">
        ...
        <article
          className="mt-10 space-y-6 text-[#4b5563] [&_a]:text-[#0a8f68] [&_a]:underline [&_h1]:text-4xl [&_h1]:font-semibold [&_h1]:tracking-[-0.04em] [&_h2]:mt-10 [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:tracking-[-0.03em] [&_h3]:mt-8 [&_h3]:text-xl [&_h3]:font-semibold [&_h4]:mt-6 [&_h4]:text-lg [&_h4]:font-semibold [&_li]:ml-6 [&_li]:list-disc [&_p]:mt-4 [&_p]:leading-8 [&_ul]:mt-4 [&_ul]:space-y-3"
